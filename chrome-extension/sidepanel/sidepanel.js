/**
 * Particles Extension - Side Panel Controller
 *
 * Handles:
...
// Initialize
// Note: Side panel is configured as tab-specific via chrome.sidePanel.open({ tabId })
// so it automatically closes when switching tabs and reopens fresh
async function init() {
...
function closeSidePanel() {
  // window.close() works for side panels
  window.close();
}

// Open URL in new tab and close the side panel
