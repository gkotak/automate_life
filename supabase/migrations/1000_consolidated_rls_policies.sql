-- ============================================================================
-- CONSOLIDATED RLS POLICIES - FINAL
-- ============================================================================
-- This is the consolidated, canonical version of all RLS policies
-- Replaces migrations: 992-997 (various RLS attempts)
--
-- Design principles:
...
-- 5. Articles are global, access control via article_users
-- ============================================================================
...
-- ============================================================================
-- STEP 10: KNOWN_CHANNELS TABLE - Authenticated access
-- ============================================================================
-- Note: Only one policy (FOR ALL) to avoid duplicate SELECT policies
...
BEGIN
  ...
  RAISE NOTICE '========================================';
  RAISE NOTICE 'CONSOLIDATED RLS POLICIES - COMPLETE';
  RAISE NOTICE '========================================';
  RAISE NOTICE '';
  ...
  RAISE NOTICE '  ✓ No duplicate policies (performance optimized)';
  RAISE NOTICE '';
