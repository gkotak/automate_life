...
# File Transcription Script V2 - Using refactored processor
...
echo "🎵 File Transcription Tool V2 - $(date)"
echo "==============================================="
...
if [ ! -f "$PYTHON_SCRIPT" ]; then
    ...
    exec "$SCRIPT_DIR/transcribe_file.sh" "$@"
fi
...
echo "🚀 Starting transcription (refactored version)..."
