#!/usr/bin/env python3
"""
Base classes and shared functionality for video summarizer components
"""
...
class BaseProcessor:
    """Base class for all video summarizer processors with shared functionality"""
    ...
    def __init__(self, session_name="base"):
        ...
        self.logs_dir = self.base_dir / "programs" / "article_summarizer_backend" / "logs"
        self.output_dir = self.base_dir / "programs" / "article_summarizer_backend" / "output"
    ...
    def _find_project_root(self):
        ...
        # Fallback: assume we're in programs/video_summarizer/common/
